...
function generateImagePrompt(title, tags) {
  ...
  return {
    prompt: `Square stained-glass illustration for "${title}". Use Christian symbolism inspired by ${keywords}. Jewel-toned glass, bold lead lines, simple centered composition, reverent mood. No people, faces, words, letters, typography, watermark, logo, or denominational branding.`,
